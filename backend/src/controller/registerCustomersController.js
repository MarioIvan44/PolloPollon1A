...
registerCustomersController.register = async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            ...
            text: "Para verificar tu cuenta, utiliza este código" + verificationCode + " Ten en cuenta que expira en 15 minutos"
        }
        ...
        console.log("error: " + error)
        return res.status(500).json({message: "Error registering customer: Internal server error"})
    }
